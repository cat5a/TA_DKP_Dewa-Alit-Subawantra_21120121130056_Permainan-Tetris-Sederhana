...
#Dewa Alit Subawantra 21120121130056
COLORS = ['dark slate blue', 'yellow2', 'green2', 'magenta3', 'turquoise1', 'Dark Orange2']       #List COLORS
...
#==========================================================================---> -----===End of Template dasar GUI===-----
    def update(self):
        ...
        self.kalo_kalah['text'] = "ANDA KALAH!\nTekan W atau Up Key\n untuk Reset!" if self.latar.kalah else ""     #Penggemar \n broo

root=tk.Tk()
GUI=Tampilan(master=root)
GUI.mainloop()      #Biar tampil GUInya (do not edit)
#---------------------------------------=============Sekian Terimakasih=============---------------------------------------